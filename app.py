...
class PropertyManagementApp(ctk.CTk):
    ...
    def create_sidebar(self):
        ...
        # Property Module (Coming Later)

        self.property_btn = ctk.CTkButton(
            self.sidebar,
            text="Property Module",
            height=45,
            command=self.property_placeholder
        )
        ...
        self.report_btn = ctk.CTkButton(
            ...
            text="Reports",
            height=45,
            command=self.report_placeholder
        )
    ...
    # Placeholder
    # ----------------------------------------
    def property_placeholder(self):

        messagebox.showinfo(
            "Coming Soon",
            "Property Module will be added later."
        )
